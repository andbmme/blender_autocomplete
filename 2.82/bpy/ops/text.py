...
def paste(selection: bool = False):
    ...
    :param selection: Selection, Paste text selected elsewhere rather than
    copied (X11 only)
    :type selection: bool
    """
...
def resolve_conflict(resolution: typing.Union[str, int] = 'IGNORE'):
    ...
    :param resolution: Resolution, How to solve conflict due to differences
    in internal and external text
