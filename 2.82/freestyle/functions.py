...
class ChainingTimeStampF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVoid > ChainingTimeStampF1D """
...
class Curvature2DAngleF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > Curvature2DAngleF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        ...
        1D element to which the freestyle.types.Interface0D pointed by the
        ...
        :rtype: float
        :return:  The 2D curvature of the 1D element evaluated at the pointed
        Interface0D.
        """
        pass
...
class Curvature2DAngleF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > Curvature2DAngleF1D """
...
class CurveMaterialF0D:
    ...
    MaterialF0D does not work with Curves and Strokes. Line color priority is
    used to pick one of the two materials at material boundaries. """
...
class CurveNatureF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DEdgeNature > CurveNatureF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        :return:  The nature of the 1D element to which the pointed
        Interface0D belongs.
        """
        pass
...
class CurveNatureF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DEdgeNature > CurveNatureF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D'
        ...
        and so on). Except if the Interface1D is a freestyle.types.ViewEdge,
        this result might be ambiguous. Indeed, the Interface1D might result
        from the gathering of several 1D elements, each one being of a
        different nature. An integration method, such as the MEAN,
        might give, in this case, irrelevant results.
...
class DensityF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > DensityF0D """
    ...
    def __init__(self, sigma: float = 2.0):
        ...
        which the gaussian function is 0.5. It leads to the window size value
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        ...
        freestyle.types.Interface0D pointed by the Interface0DIterator. This
...
class DensityF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > DensityF1D """
    ...
    def __init__(self,
        ...
        corresponding 0D function is evaluated at each sample point and the
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> float:
        ...
        freestyle.functions.DensityF0D functor) with a user-defined sampling
        and then integrated into a single value using a user-defined
        integration method.
...
class GetCompleteViewMapDensityF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetCompleteViewMapDensityF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> float:
        ...
        freestyle.functions.ReadCompleteViewMapPixelF0D functor) and then
        integrated into a single value using a user-defined integration method.
...
class GetCurvilinearAbscissaF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DFloat > GetCurvilinearAbscissaF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        ...
        freestyle.types.Interface0D pointed by the Interface0DIterator in the
        context of its 1D element.
...
class GetDirectionalViewMapDensityF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetDirectionalViewMapDensityF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> float:
        ...
        steerable viewmaps image. The direction telling which Directional map
        to choose is explicitly specified by the user. The density is
        evaluated for a set of points along the Interface1D (using the
        freestyle.functions.ReadSteerableViewMapPixelF0D functor) and then
        integrated into a single value using a user-defined integration method.
...
class GetOccludeeF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DViewShape > GetOccludeeF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        """Returns the freestyle.types.ViewShape that the Interface0D pointed
        by the Interface0DIterator occludes.
...
class GetOccludeeF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVectorViewShape > GetOccludeeF1D """
...
class GetOccludersF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DVectorViewShape > GetOccludersF0D """
...
class GetOccludersF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVectorViewShape > GetOccludersF1D """
...
class GetParameterF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DFloat > GetParameterF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the parameter of the freestyle.types.Interface0D pointed
        by the Interface0DIterator in the context of its 1D element.
...
class GetProjectedXF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > GetProjectedXF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the X 3D projected coordinate of the
        freestyle.types.Interface0D pointed by the Interface0DIterator.
...
class GetProjectedXF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetProjectedXF1D """
...
class GetProjectedYF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > GetProjectedYF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the Y 3D projected coordinate of the
        freestyle.types.Interface0D pointed by the Interface0DIterator.
...
class GetProjectedYF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetProjectedYF1D """
...
class GetProjectedZF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > GetProjectedZF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the Z 3D projected coordinate of the
        freestyle.types.Interface0D pointed by the Interface0DIterator.
...
class GetProjectedZF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetProjectedZF1D """
...
class GetShapeF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DViewShape > GetShapeF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        """Returns the freestyle.types.ViewShape containing the Interface0D
...
class GetShapeF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVectorViewShape > GetShapeF1D """
...
class GetSteerableViewMapDensityF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetSteerableViewMapDensityF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> float:
        ...
        density of each freestyle.types.FEdge is evaluated in the proper
        steerable freestyle.types.ViewMap depending on its orientation.
...
class GetViewMapGradientNormF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DFloat > GetViewMapGradientNormF0D """
...
class GetViewMapGradientNormF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetViewMapGradientNormF1D """
...
class GetXF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > GetXF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the X 3D coordinate of the freestyle.types.Interface0D
        pointed by the Interface0DIterator.
...
class GetXF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetXF1D """
...
class GetYF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > GetYF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the Y 3D coordinate of the freestyle.types.Interface0D
        pointed by the Interface0DIterator.
...
class GetYF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetYF1D """
...
class GetZF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > GetZF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the Z 3D coordinate of the freestyle.types.Interface0D
        pointed by the Interface0DIterator.
...
class GetZF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > GetZF1D """
...
class IncrementChainingTimeStampF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVoid > IncrementChainingTimeStampF1D """
...
class LocalAverageDepthF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > LocalAverageDepthF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        """Returns the average depth around the freestyle.types.Interface0D
        pointed by the Interface0DIterator. The result is obtained by
        querying the depth buffer on a window around that point.
...
class LocalAverageDepthF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > LocalAverageDepthF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> float:
        ...
        average depth is evaluated for a set of points along the Interface1D
        (using the freestyle.functions.LocalAverageDepthF0D functor) with a
...
class MaterialF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DMaterial > MaterialF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        freestyle.types.Interface0D pointed by the Interface0DIterator. This
        evaluation can be ambiguous (in the case of a freestyle.types.TVertex
        for example. This functor tries to remove this ambiguity using the
        ...
        different materials on each side of the point. However, there still
        can be problematic cases, and the user willing to deal with this
        cases in a specific way should implement its own getMaterial functor.
...
class Normal2DF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DVec2f > Normal2DF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        """Returns a two-dimensional vector giving the normalized 2D normal
        to the 1D element to which the freestyle.types.Interface0D pointed by
        the Interface0DIterator belongs. The normal is evaluated at the
        pointed Interface0D.
...
class Normal2DF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVec2f > Normal2DF1D """
...
class Orientation2DF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVec2f > Orientation2DF1D """
...
class Orientation3DF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVec3f > Orientation3DF1D """
...
class QuantitativeInvisibilityF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DUnsigned > QuantitativeInvisibilityF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> int:
        ...
        evaluation can be ambiguous (in the case of a freestyle.types.TVertex
        for example). This functor tries to remove this ambiguity using the
        context offered by the 1D element to which the Interface0D belongs
        to. However, there still can be problematic cases, and the user
        willing to deal with this cases in a specific way should implement
...
class QuantitativeInvisibilityF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DUnsigned > QuantitativeInvisibilityF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> int:
        ...
        If the Interface1D is a freestyle.types.ViewEdge, then there is no
        ambiguity concerning the result. But, if the Interface1D results of a
        chaining (chain, stroke), then it might be made of several 1D
...
class ReadCompleteViewMapPixelF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DFloat > ReadCompleteViewMapPixelF0D """
...
class ReadMapPixelF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DFloat > ReadMapPixelF0D """
...
class ReadSteerableViewMapPixelF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DFloat > ReadSteerableViewMapPixelF0D """
...
class ShapeIdF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DId > ShapeIdF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        freestyle.types.Interface0D pointed by the Interface0DIterator
        belongs to. This evaluation can be ambiguous (in the case of a
        freestyle.types.TVertex for example). This functor tries to remove
        this ambiguity using the context offered by the 1D element to which
        the Interface0DIterator belongs to. However, there still can be
        problematic cases, and the user willing to deal with this cases in a
        specific way should implement its own getShapeIdF0D functor.
...
class TimeStampF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DVoid > TimeStampF1D """
...
class VertexOrientation2DF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DVec2f > VertexOrientation2DF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        the 1D element to which the freestyle.types.Interface0D pointed by
        the Interface0DIterator belongs. The 2D oriented tangent is evaluated
...
class VertexOrientation3DF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DVec3f > VertexOrientation3DF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator'
        ...
        to the 1D element to which the freestyle.types.Interface0D pointed by
        the Interface0DIterator belongs. The 3D oriented tangent is evaluated
        at the pointed Interface0D.
...
class ZDiscontinuityF0D:
    """Class hierarchy: freestyle.types.UnaryFunction0D >
    freestyle.types.UnaryFunction0DDouble > ZDiscontinuityF0D """
    ...
    def __call__(self, it: 'freestyle.types.Interface0DIterator') -> float:
        ...
        freestyle.types.Interface0D pointed by the Interface0DIterator and
        the shape that lies behind (occludee). This distance is evaluated in
        the camera space and normalized between 0 and 1. Therefore,
        if no object is occluded by the shape to which the Interface0D
        belongs to, 1 is returned.

        :param it: An Interface0DIterator object. 
        :type it: 'freestyle.types.Interface0DIterator'
        :rtype: float
        :return:  The normalized distance between the pointed Interface0D and
        the occludee.
        """
        pass
...
class ZDiscontinuityF1D:
    """Class hierarchy: freestyle.types.UnaryFunction1D >
    freestyle.types.UnaryFunction1DDouble > ZDiscontinuityF1D """
    ...
    def __call__(self, inter: 'freestyle.types.Interface1D') -> float:
        ...
        and the shape that lies behind (occludee). This distance is evaluated
        in the camera space and normalized between 0 and 1. Therefore,
        if no object is occluded by the shape to which the Interface1D
        belongs to, 1 is returned.

        :param inter: An Interface1D object. 
        :type inter: 'freestyle.types.Interface1D'
        :rtype: float
        :return:  The normalized distance between the Interface1D and the
        occludee.
        """
        pass
